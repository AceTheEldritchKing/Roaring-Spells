...
public class RedCleaveParticle extends TextureSheetParticle {
    private final SpriteSet sprites;
    private final Vec3 forward;
    private final boolean mirror, vertical;
    private final Vector3f[] localVertices;

    RedCleaveParticle(ClientLevel level, double x, double y, double z, SpriteSet spriteSet, double xd, double yd, double zd, RedCleaveParticleOptions options) {
        super(level, x, y, z);
    ...
    @OnlyIn(Dist.CLIENT)
    public static class Provider implements ParticleProvider<RedCleaveParticleOptions>
    {
        ...
        @Override
        public @Nullable Particle createParticle(RedCleaveParticleOptions redCleaveParticleOptions, ClientLevel clientLevel, double v, double v1, double v2, double v3, double v4, double v5) {
            RedCleaveParticle slashParticle = new RedCleaveParticle(clientLevel, v, v1, v2, sprite, v3, v4, v5, redCleaveParticleOptions);
