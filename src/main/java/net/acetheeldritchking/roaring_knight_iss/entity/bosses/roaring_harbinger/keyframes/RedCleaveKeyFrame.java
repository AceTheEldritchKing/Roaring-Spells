...
public class RedCleaveKeyFrame extends AttackKeyframe {
    ...
    public RedCleaveKeyFrame(int timeStamp, Vec3 lungeVector, SwingData swingData) {
        this(timeStamp, lungeVector, Vec3.ZERO, swingData);
    }

    public RedCleaveKeyFrame(int timeStamp, Vec3 lungeVector, Vec3 extraKnockback, SwingData swingData) {
