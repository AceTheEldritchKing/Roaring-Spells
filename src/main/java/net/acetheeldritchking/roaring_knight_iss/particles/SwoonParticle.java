...
public class SwoonParticle extends TextureSheetParticle {
    ...
    SwoonParticle(ClientLevel level, double x, double y, double z, SpriteSet spriteSet, double xd, double yd, double zd, @UnknownNullability SwoonParticleOptions options) {
        super(level, x, y, z);
    ...
    @OnlyIn(Dist.CLIENT)
    public static class Provider implements ParticleProvider<SwoonParticleOptions>
    {
        ...
        @Override
        public @Nullable Particle createParticle(SwoonParticleOptions redCleaveParticleOptions, ClientLevel clientLevel, double v, double v1, double v2, double v3, double v4, double v5) {
            SwoonParticle slashParticle = new SwoonParticle(clientLevel, v, v1, v2, sprite, v3, v4, v5, redCleaveParticleOptions);
