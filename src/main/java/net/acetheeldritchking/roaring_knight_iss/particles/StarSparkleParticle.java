...
public class StarSparkleParticle extends TextureSheetParticle {
    ...
    public StarSparkleParticle(ClientLevel level, double x, double y, double z, SpriteSet spriteSet, double xd, double yd, double zd) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType>
    {
        ...
        public @Nullable Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double x, double y, double z, double dx, double dy, double dz) {
            return new StarSparkleParticle(clientLevel, x, y, z, this.sprites, dx, dy, dz);
        }
    }
}
